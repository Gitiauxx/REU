...
graduated = graduated[((graduated['GRADTERM'].astype(str).str.contains('2013')) == True) & ((graduated.degmaj1.isin(['CS'])==True) | (graduated.degmaj1.isin(['ACS'])==True)) & ((graduated.cohort_pmajr.isin(['CS'])==True) | (graduated.cohort_pmajr.isin(['ACS'])==True))]
